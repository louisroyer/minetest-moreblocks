...
function stairsplus:register_slope(modname, subname, recipeitem, fields, fulldescs)
	local defs = table.copy(stairsplus.defs["slope"])
	for alternate, def in pairs(defs) do
		stairsplus.register_single("slope", alternate, def, modname, subname, recipeitem, fields, (fulldescs and fulldescs["slope"..alternate] or nil))
	end
