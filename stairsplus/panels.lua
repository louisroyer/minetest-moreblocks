...
function stairsplus:register_panel(modname, subname, recipeitem, fields, fulldescs)
	local defs = table.copy(stairsplus.defs["panel"])
	for alternate, def in pairs(defs) do
		stairsplus.register_single("panel", alternate, def, modname, subname, recipeitem, fields, (fulldescs and fulldescs["panel"..alternate] or nil))
	end
